    ...
    <>
        <main>
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              >
                <p>
                  <Bed className="inline-block mr-1"/> {property.beds}
                  <span className="hidden sm:inline">Beds</span>
                </p>
                <p>
                  <Bath className="inline-block mr-1"/> {property.baths}
                  <span className="hidden sm:inline">Baths</span>
                </p>
                <p>
                  <Ruler className="inline-block mr-1"/> {property.square_feet}
            ...
            <div className="bg-white p-6 rounded-lg shadow-md mt-6">
              ...
              >
                {property.amenities.map((amenity, index) => (
                  <li key={index}>
                    <Check className="inline-block mr-1 text-green-500"/> {amenity}
                  </li>
                ))}
              </ul>
            </div>
